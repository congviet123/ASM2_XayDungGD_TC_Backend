...
<template>
  <div id="app">
    ...
    <header class="bg-primary text-white py-3 shadow-sm">
      <div class="container d-flex justify-content-between align-items-center">
        ...
        <nav class="d-flex flex-wrap gap-2">
          ...
          <button class="btn btn-outline-light" @click="openPostModal">📝 Đăng Bài Viết</button>
    ...
    <PostModal :showModal="showPostModal" @close="closePostModal" @submit="handlePostSubmit" />
